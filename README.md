...
| File | Description |
| --- | --- |
| `index.html` | Main HTML/CSS/JS page. Includes the confetti animation and modal card layout. |
| `prae-with-golden-min.png` | Anime illustration displayed inside the photo frame. |

## Preview locally

Open `index.html` directly in your browser (double-click the file) – everything is self-contained.
...
3. After GitHub Pages builds, access `https://<username>.github.io/<repo>/index.html`.

## Customization

- Edit the copy inside `index.html` to change messages or verses.
